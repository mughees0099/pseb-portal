export const Verification_Email_Template = `
  ...
  <body>
      <div class="container">
          ...
          <div class="footer">
              <p>&copy; ${new Date().getFullYear()} Riphah University and IPsec. All rights reserved.</p>
          </div>
      </div>
  </body>
  </html>
...
export const Password_Reset_Email_Template = ` 
    ...
    <body>
        <div class="container">
            ...
            <div class="content">
                <p>Hello,</p>
                <p>You recently requested to reset your password. Please use the code below to reset your password:</p>
                <span class="verification-code">{ResetVerificationCode}</span> 
